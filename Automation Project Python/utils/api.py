...
class Google_maps_api():
    ...
    def create_new_place():
        ...
        print(post_url)
        result_post = Http_method.post(post_url, json_dor_create_new_place)
    ...
    """Метод для изминения новой локации"""
    ...
    def delete_new_place(place_id):
        ...
        result_delete = Http_method.put(delete_url, json_for_delete_new_location)
